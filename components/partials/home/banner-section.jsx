...
function BannerSection( props ) {
    const { subTitle = "Accessories for", title = "Summer Season's", url = "https://image.freepik.com/free-vector/abstract-dotted-banner-background_1035-18160.jpg", titleAdClass = '' } = props;
    return (
